          ...
          <table className="w-full">
            <thead className="bg-muted border-b border-border">
              <tr>
                ...
                <th className="text-left px-6 py-3 text-sm font-semibold text-foreground">Allocated</th>
                <th className="text-left px-6 py-3 text-sm font-semibold text-foreground">Available</th>
                <th className="text-left px-6 py-3 text-sm font-semibold text-foreground">Utilization</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {teamCapacity.map((item) => (
                <tr key={item.role} className="hover:bg-muted/50">
                  <td className="px-6 py-4 text-sm font-medium text-foreground">{item.role}</td>
                  <td className="px-6 py-4 text-sm text-foreground">{item.allocated}</td>
