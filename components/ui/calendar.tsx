  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 rounded-md data-[selected=true]:rounded-none border-2 border-purple-500",
